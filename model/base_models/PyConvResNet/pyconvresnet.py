...
class PyConvResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, norm_layer=None, in_channel=3, dropout_prob0=0.0):
...
def pyconvresnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # model.load_state_dict(torch.load('/home/sjh/.cache/torch/checkpoints/ade20k_pyconvresnet50_pyconvsegnet.pth'))
    return model
